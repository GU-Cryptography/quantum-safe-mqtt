...
def check_ca_cert_file_name(data):
    """Ensures the cert_file_name is a string"""
    ca_cert_file_name = get_parameter(data, "ca_cert_file_name")
    if not isinstance(ca_cert_file_name, str):
        raise InvalidParameterError(f'cert_file_name must be a string. \n'
                                    f'The cert_file_name type in the config file was: {type(ca_cert_file_name)}')
    return ca_cert_file_name
